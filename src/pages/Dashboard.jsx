    ...
    <>
      ...
      <section className="min-h-screen bg-[#FAF8F5] px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 py-6 sm:py-8 md:py-10 lg:py-12">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {/* HERO SECTION */}
          <div className="rounded-2xl sm:rounded-3xl md:rounded-4xl bg-linear-to-r from-[#1F3D2B] via-[#2F6B4F] to-[#3A8060] text-white p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12 shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 md:gap-6 mt-6 sm:mt-7 md:mt-8">
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4">
              <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-sm border border-gray-100">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold mt-1 sm:mt-2 text-[#1F3D2B]">
                  --
                </h3>
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-sm border border-gray-100">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-bold mt-2 sm:mt-3 text-green-600">
                  Active
                </h3>
                <p className="text-xs text-gray-400 mt-1 sm:mt-2">
                  Account Verified
          ...
          <div className="mt-6 sm:mt-7 md:mt-8 bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 md:p-7 shadow-sm border border-gray-100">
            ...
            >
              <FiLogOut size={16} className="sm:w-4.5 sm:h-4.5" />
              Logout
            </button>
          </div>
        </div>
      ...
      {/* TOAST */}
      <div className="fixed top-4 right-4 sm:top-5 sm:right-5 left-4 sm:left-auto flex flex-col gap-2 sm:gap-3 z-50">
        {toast.map((t) => (
          <Toast
            key={t.id}
            message={t.message}
